...
root=Tk()
root.title("python.ogreniyorum - Text Editor Python")

savebtn=Button(root,command=saveDoc,text="Kaydet")
savebtn.grid(row=1,column=0)
savebtn.config(font=('arial',20,'bold'),bg="DodgerBlue2",fg="red")
...
boldbtn=Button(root,command=boldDoc,text="Kalın")
boldbtn.grid(row=1,column=2)
boldbtn.config(font=('arial',20,'bold'),bg="DodgerBlue2",fg="black")
